    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 to-sky-900 text-white font-sans">
      ...
      <section className="max-w-5xl mx-auto px-4 py-10">
        ...
        <p className="mb-10 leading-relaxed">
          We are 3 students with a passion for MERN stack development
          ...
          at the department of Together, our collaboration resulted in a captivating, enjoyable and user-friendly{" "}
